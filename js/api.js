...
function fetchResults(e) {
  ...
  url = `${baseURL}`;
  //if/else for all variables of search fields to build url
  if (
    season.value !== "" &&
    driverName.value === "" &&
    constructors.value === "" &&
  ...
  function displayResults(json) {
    ...
    //error handling try/catch for no results
    try {
      //if/else for digging into json data and building table data
      if (
        (season.value !== "" &&
          driverName.value === "" &&
          constructors.value === "" &&
